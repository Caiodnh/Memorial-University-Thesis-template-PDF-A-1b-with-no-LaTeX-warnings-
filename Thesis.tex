...
%%%% instead. ie, replace the command before and uncomment
%%%% the following line
...
%%%% There are things that go in the front page, like the Title and Student's and Supervisor's name
...
%%%% Abstract, Lay Summary, Acknowledgments, Statement of Contribution and Table of Contents.
...
%%%% In this template, I have separate files for it chapter, in the corresponding folder
